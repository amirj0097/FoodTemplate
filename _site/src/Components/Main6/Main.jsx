      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-2/5">
            <div className="bg-linear-to-r from-red-50 to-orange-50 rounded-xl p-5 shadow-sm border border-red-100">
              <div className="mb-4">
              ...
              <div className="mb-5">
                <div className="bg-white rounded-lg p-2">
                  <div className="h-48 bg-linear-to-br from-amber-900 to-amber-700 rounded-md overflow-hidden">
                    <img 
              ...
              <button className="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 rounded-lg transition duration-300 text-sm">
                Buy Now
              </button>
            </div>
          </div>
          ...
          <div className="lg:w-3/5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100">
                  {/* تصویر محصول */}
                  <div className="mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-bold text-red-600 text-sm">${product.discountPrice.toFixed(2)}</span>
                    ...
                    {/* دکمه خرید */}
                    <button className="w-full bg-linear-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white text-xs font-medium py-1.5 rounded transition duration-300">
                      Buy Now
                    </button>
                  </div>
                </div>
